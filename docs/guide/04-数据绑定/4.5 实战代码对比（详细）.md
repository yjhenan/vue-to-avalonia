...
public class RegisterViewModel : ReactiveObject
{
    ...
    {
        get => usernameError;
        set => this.RaiseAndSetIfChanged(ref usernameError, value);
    }
    ...
    public RegisterViewModel()
    {
        ...
        this.WhenAnyValue(
            ...
            x => x.EmailError,
            x => x.PasswordError)
            .Subscribe(_ => this.RaisePropertyChanged(nameof(IsFormValid)));
    }
    ...
    private void ValidateEmail()
    {
        ...
        this.RaisePropertyChanged(nameof(HasEmailError));
    }
